        ...
        <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;">
            ...
            <el-row>
                <el-col :span="9" style="padding: 0px 10px 20px 0px">
                    <img :src="$page.userlist.imageUrl" style="width: 100%;border-radius:5px;">
                    <div style="padding: 10px">
                        <font style="font-size: 26px;line-height: 40px;font-weight: 600">{{name}}
                            <br>
                        </font>
                        <font style="font-size: 20px;font-style: normal;font-weight: 300;line-height: 35px;color: #666;">{{$page.userlist.name}}
                            <br>
                        </font>
